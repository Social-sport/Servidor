  ...
  <div class="list-group" id="listDeportes">
    ...
    <a href="#" class="list-group-item active" id="itemDeporte">
      ...
      <div class="col-md-6">
        ...
        popularmente como ping-pong o pimpón) </p>
      </div>
    ...
    <a href="#" class="list-group-item"  id="itemDeporte">
      ...
      <div class="col-md-6">
        ...
        <p class="list-group-item-text"> El fútbol o balompié (inglés británico football),
           Es el deporte más popular del mundo. </p>
      </div>
      <div class="col-md-3 text-center">
    ...
    <a href="#" class="list-group-item"  id="itemDeporte">
      ...
      <div class="col-md-6">
        ...
        <p class="list-group-item-text"> baloncesto, basquetbol o básquetbol, basketball. </p>
      </div>
      <div class="col-md-3 text-center">
    ...
    <a href="#" class="list-group-item"  id="itemDeporte">
      ...
      <div class="col-md-6">
        ...
        <p class="list-group-item-text"> El ajedrez en su versión de competición está considerado deporte.
        </p>
      </div>
      <div class="col-md-3 text-center">
