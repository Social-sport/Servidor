 ...
 * 		POST /deportes. Petici�n para suscribir un usuario a un deporte.
 * 		GET /deportes. Petici�n para listar los deportes de la base de datos.
 * 		DELETE /deportes. Petici�n para dar de baja a un usuario de un deporte.
 */
...
public class DeportesServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//Si se pide listar los deortes a los que est� suscrito el usuario
